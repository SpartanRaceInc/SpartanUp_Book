				...
				<div class="row">
					...
					<div class="col-lg-4 col-lg-offset-1 featured float-right" style="z-index:30;">	
						...
						<div class="event-recap">
							...
							<p></p>
							<a href="http://www.amazon.com/gp/product/0544286170/ref=as_li_tf_tl?ie=UTF8&amp;camp=1789&amp;creative=9325&amp;creativeASIN=0544286170&amp;linkCode=as2&amp;tag=spartanraceco-20" class="event-button">Order on Amazon</a><img src="http://ir-na.amazon-adsystem.com/e/ir?t=spartanraceco-20&amp;l=as2&amp;o=1&amp;a=0544286170" width="1" height="1" border="0" alt="" style="border:none !important; margin:0px !important; height:1px !important; width:1px !important;" />
...
<h3>&mdash; An entreprenuer from 8 years old Joe has had a passion for life that moves the ball forward against all odds. Born in Queens NY to a yoga teaching, meditation practicing mother and an Italian father that was an uber-entrepreneur the author learned simple techniques for forging ahead no matter the odds.</h3>
		...
		<section class="about light-gray-background" id="about">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<h2 class="no-margin-bottom"><em>Spartan Up!</em> is more than an insider’s view of the world of obstacle racing</h2>
						<h3>It’s a manual for the Spartan way of life, including:</h3>
					</div>
				</div>
				<div class="row">
					...
					<div class="col-md-6">
						<ul class="info">
							<li><strong>Getting Spartan fit:</strong> Survival of the Fittest means training outside the gym for strength, endurance and flexibility for your entire body—and don’t forget those burpees!</li>
							<li><strong>Moving mountains:</strong> Whether metaphorical mountains or the ones on which Spartans race, what you think of as your limitations can actually be a mere starting point for transformation.</li>
						</ul>
					</div>
					<!-- End Second Feature 
					============================================== -->
...
<?php require_once('partials/buysavehero.php'); ?>	
		...
		Testimonials
		=============================================== -->
		<section class="testimonials white-background" id="testimonials">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
